...
func printHelp() {
	...
	fmt.Println()
	fmt.Println("Zeropages $08-$0f are used in the animation displayer, while none are used")
	fmt.Println("in hires/koala displayers, increasing sid compatibility.")
	fmt.Println()
	fmt.Println("## Changes for version 1.1")
	fmt.Println()
	fmt.Println(" - Added displayer for koala animations.")
	fmt.Println(" - Fixed bug in koala/hires displayers not allowing sids between 0xc000-0xc7ff.")
	fmt.Println()
