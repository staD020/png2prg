...
func printHelp() {
	...
	fmt.Println("color-order. You must use c64 colors, so 0 for black, 1 for white,")
	...
	fmt.Println("The base image will be exported and each frame as a separate .prg,")
