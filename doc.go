...
func PrintHelp() {
	...
	fmt.Println()
	fmt.Println("First [install Go 1.20 or higher](https://go.dev/dl/) and the Java Runtime Environment to")
	fmt.Println("compile the displayers and png2prg. KickAss.jar is included in this repo.")
	fmt.Println()
	...
	fmt.Println("However, natively building on Windows should be easy enough.")
	fmt.Println()
	...
	fmt.Println()
	fmt.Println("Compile all displayers, then compile png2prg.")
	fmt.Println()
	fmt.Println("    java -jar ./tools/KickAss-5.25.jar -o display_koala.prg display_koala.asm")
	fmt.Println("    java -jar ./tools/KickAss-5.25.jar -o display_hires.prg display_hires.asm")
	fmt.Println("    ...")
