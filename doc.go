...
func PrintHelp() {
	...
	fmt.Println("This release also contains an important bugfix related to mixedcharsets,")
	...
	fmt.Println()
	fmt.Println("See 'Changes for version 1.11' below for more details.")
	fmt.Println()
	...
	fmt.Println(" - Feature: Docker build support was added by Trident (thanks!)")
	...
	fmt.Println("Acrouzet, Trident and Worrior1.")
	fmt.Println()
	fmt.Println("## Options")
	fmt.Println()
	fmt.Println("```")
