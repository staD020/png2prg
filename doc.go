...
func PrintHelp() {
	...
	fmt.Println("multicolor bitmap, charset, petscii or sprites prg. It will find the best")
	...
	fmt.Println()
	fmt.Println("## Singlecolor or PETSCII Charset (individual d800 colors)")
	fmt.Println()
	...
	fmt.Println(" - Added -mode petscii support including auto-detection and sid support.")
	fmt.Println()
