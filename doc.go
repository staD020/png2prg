...
func PrintHelp() {
	...
	fmt.Println(" - Add experimental -brute-force mode to find bitpair color combinations")
	fmt.Println("   with better crunchiness. Burns some CPU for a couple seconds.")
