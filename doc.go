...
func PrintHelp() {
	...
	fmt.Println("See testdata/charanim for an example.")
	fmt.Println()
	...
	fmt.Println(" - Add -no-anim flag disable mccharset animations and store frames as separate")
	fmt.Println("   screens.")
	fmt.Println(" - Add sccharset animation support and move separate screens to -no-anim.")
	fmt.Println(" - Add mixedcharset animation support and move separate screens to -no-anim.")
	fmt.Println(" - Add -no-fade flag for koala, hires and petscii animation displayers, this")
	fmt.Println("   frees up a lot of RAM for animation data and sid.")
