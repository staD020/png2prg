...
func PrintHelp() {
	...
	fmt.Println("    D021:    $7f40         (multicolor only, low-nibble)")
	fmt.Println("    D020:    $7f40         (multicolor only, high-nibble)")
	...
	fmt.Println(" - Experimental interlace support, mci bitmap (with shared screen/color) only.")
	fmt.Println()
