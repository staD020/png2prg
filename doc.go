...
func PrintHelp() {
	...
	fmt.Println()
	fmt.Println("Png2prg 1.10 introduces petscii animation support, including unique border and")
	...
	fmt.Println()
	fmt.Println("See 'Changes for version 1.10' below for more details.")
	fmt.Println()
	...
	fmt.Println()
	fmt.Println("Since version 1.12 the -anim-csv flag has been added to give more")
	fmt.Println("freedom to users wanting to create animation displayers.")
	fmt.Println("It is now possible to have a custom -frame-delay per frame.")
	fmt.Println()
	fmt.Println("The csv should simply look like this, rows of frame delay value and image:")
	fmt.Println()
	...
	fmt.Println()
	fmt.Println("    png2prg -d -o evoluer.prg -sid testdata/evoluer/Evoluer.sid -anim-csv testdata/evoluer/evoluer.csv")
	fmt.Println("    png2prg -d -o rose.prg -anim-csv testdata/petscii/anim/rose.csv")
	fmt.Println()
	...
	fmt.Println(" - Feature: Add -anim-csv support to allow for per frame delays.")
