...
func PrintHelp() {
	...
	fmt.Println()
	fmt.Println("This tool can be used in all buildchains and all common platforms.")
	fmt.Println()
	...
	fmt.Println(" - Added -force-pack-empty for singlecolor charset, may save a char, but")
