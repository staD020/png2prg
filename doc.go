...
func PrintHelp() {
	...
	fmt.Println()
	fmt.Println("Png2prg 1.11 introduces animation.csv support for custom delays per frame.")
	...
	fmt.Println()
	fmt.Println("And finally Trident added [devcontainer files](https://github.com/staD020/png2prg/commit/6cb6c48a2804fa5210cf704e0af4cff3313398fe) for setting up a Docker")
	fmt.Println("development environment to compile the code directly from within VSCode.")
	fmt.Println()
	fmt.Println("See 'Changes for version 1.11' below for more features and details.")
	fmt.Println()
