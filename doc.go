...
func PrintHelp() {
	...
	fmt.Println("The displayers for koala and hires include fullscreen fade-in/out and")
	...
	fmt.Println("    mcibitmap: 320x200 multicolor bitmap (max 4 colors per char)")
	fmt.Println()
	...
	fmt.Println(" - Experimental interlace support, mci bitmap only for now,")
	fmt.Println("   with shared screen/colram.")
	fmt.Println()
