...
dist: $(ALLTARGETS) $(TARGET) readme.md $(TESTSID) $(TESTSID2) $(TESTSIDMAD) $(TESTSIDANIM)
	...
	./$(TARGET) -d -q -bf -o dist/superscope.prg -sid testdata/pocket_universe_8580.sid testdata/petscii/anim/rebel1_superscope.gif
	./$(TARGET) -d -q -bf -o dist/oceanborn.prg -sid testdata/Ocean_Reloaded_90.sid testdata/petscii/anim/oceanborn?.png
	./$(TARGET) -d -q -bf -o dist/rose.prg -sid testdata/petscii/anim/English_Rose.sid testdata/petscii/anim/rose?.png testdata/petscii/anim/rose5.png testdata/petscii/anim/rose4.png testdata/petscii/anim/rose3.png testdata/petscii/anim/rose2.png testdata/petscii/anim/rose1.png
