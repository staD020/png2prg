...
func initAndParseFlags() (opt png2prg.Options) {
	...
	flag.StringVar(&opt.BitpairColorsString2, "bpc2", "", "secondary bitpair colors eg 0,2,10,7")
	flag.StringVar(&opt.BitpairColorsString3, "bpc3", "", "tertiary bitpair colors eg 0,11,12,15")
	...
	flag.BoolVar(&opt.NoFade, "no-fade", false, "do not use fade in/out and free up a lot of memory")
