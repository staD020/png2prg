...
usage: ./png2prg [-help -h -d -q -v -force-bg-col 0 -o outfile.prg -td testdata] FILE [FILE..]

Png2prg converts a 320x200 image (png/gif/jpeg) to a c64 single- or multicolor
bitmap. It will find the best matching palette and backgroundcolor
...
Animation (Multicolor Bitmap Only):
